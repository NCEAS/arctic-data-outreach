...
twitter_summary_metrics <- read_csv("~/Documents/Twitter Analytics/Raw Dataone/twitter-summary-metrics-d1.csv")
...
files <- list.files("~/Documents/Twitter Analytics/Raw Dataone/",pattern="tweet_activity_metrics_DataONEorg_",full.names=TRUE)
