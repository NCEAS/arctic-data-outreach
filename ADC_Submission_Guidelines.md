...
The Arctic Data Center primarily archives data packages. Data packages on the Arctic Data Center are simply defined as a collection of related data and metadata objects. On the Arctic Data Center, each data package should contain, when possible, all of the relevant data and metadata from a specific research project (or sub-project/project component).
